...
return [
    'modules' => [
        ...
        'Bay20_Bay20CustomJS' => 1,
        'Bss_AddProductAttribute' => 1,
        'Bss_Schema' => 0,
        'Codilar_HelloWorld' => 1,
        'Company_Module' => 0,
        'Custom_ConfigViewer' => 1,
        'Custom_ConfigViewerAdmin' => 1,
        'Custom_MiniCartProductList' => 0,
        'Custom_MinicartMove' => 0,
        'Custom_MinicartPosition' => 0,
        'Custom_Module' => 0,
        'Feedback_Myreview' => 0,
        'Learning_Feedback' => 1,
        'Learning_TestPlugin' => 1,
        'Mageants_Blog' => 1,
        'Magento4u_AdminInterface' => 0,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Ron_HelloWorld' => 0,
        'Ron_Module' => 1,
        'Tasks_CustomerFeedback' => 0,
        'Temando_ShippingRemover' => 1,
        'Thecoachsmb_Backendtheme' => 0,
        'Toggle_Dump' => 1,
        'Vendor_CustomBrand' => 1,
        'Vendor_Extension' => 0,
    ],
    'scopes' => [
        'websites' => [
     ...
     * CONFIG__DEFAULT__CATALOG__SEARCH__OPENSEARCH_SERVER_HOSTNAME for catalog/search/opensearch_server_hostname
     ...
     * CONFIG__DEFAULT__CATALOG__SEARCH__OPENSEARCH_USERNAME for catalog/search/opensearch_username
     ...
     * CONFIG__DEFAULT__CATALOG__SEARCH__OPENSEARCH_PASSWORD for catalog/search/opensearch_password
    ...
    'system' => [
        'default' => [
            ...
            'payment' => [
                ...
                'braintree_webhook' => [
                    'enabled' => '0',
                    'fraud_protection_url' => null,
                    'approve_order_status' => 'processing',
                    'reject_order_status' => 'canceled',
                ],
                ...
                'braintree_local_payment' => [
                    ...
                    'order_status' => 'processing',
                    'payment_action' => 'authorize_capture',
                    'paymentInfoKeys' => 'processorAuthorizationCode,processorResponseCode,processorResponseText,paymentId,fundingSource',
                    'privateInfoKeys' => 'processorAuthorizationCode,processorResponseCode,processorResponseText,paymentId,fundingSource',
                    'group' => 'braintree_group',
                ],
                'braintree_googlepay' => [
                    'active' => '0',
            ...
            'general' => [
                ...
                'region' => [
                    'state_required' => 'AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,CZ,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,US,UY,VE',
                    'display_all' => '1',
                ],
                'locale' => [
            ...
            'admin' => [
                ...
                'grid' => [
                    'limit_total_number_of_products' => '0',
                    'records_limit' => '20000',
                ],
                'captcha' => [
                    'enable' => '1',
            ...
            'catalog' => [
                ...
                'search' => [
                    ...
                    'opensearch_test_connect_wizard' => null,
                    ...
                    'opensearch_minimum_should_match' => null,
                ],
                'downloadable' => [
                    'order_item_status' => '9',
                    'downloads_number' => '0',
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'adobe_ims' => [
                'integration' => [
                    ...
                    'admin' => [
                        'auth_url_pattern' => 'https://ims-na1.adobelogin.com/ims/authorize/v2?client_id=#{client_id}&redirect_uri=#{redirect_uri}&locale=#{locale}&scope=#{scope}&state=#{state}&response_type=code',
                        'reauth_url_pattern' => 'https://ims-na1.adobelogin.com/ims/authorize/v2?client_id=#{client_id}&redirect_uri=#{redirect_uri}&locale=#{locale}&scope=#{scope}&state=#{state}&response_type=code&reauth=check',
                        'scopes' => [
                            'AdobeID' => 'AdobeID',
                            'openid' => 'openid',
                            'email' => 'email',
                    ...
                    'admin_logout_url' => 'https://ims-na1.adobelogin.com/ims/logout/v1',
                    'certificate_path' => 'https://static.adobelogin.com/keys/prod/',
                    'validate_token_url' => 'https://ims-na1.adobelogin.com/ims/validate_token/v1',
                ],
                'email' => [
...
Disallow: /*SID=
            ...
            'twofactorauth' => [
                'duo' => [
                    'application_key' => 'GN4XKcwckJdtHnioV0g2UGXbazc8BOL36UgB4GWjHW3f1X4rGrBQ1jmPNqb3Rw0m',
                ],
            ],
        ],
        'stores' => [
    ...
    'themes' => [
        ...
        'frontend/Mytheme/Logo' => [
            'parent_id' => null,
            'theme_path' => 'Mytheme/Logo',
            'theme_title' => 'CustomLogo',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'Mytheme/Logo',
        ],
        'frontend/Thecoachsmb/mytheme' => [
            'parent_id' => 'Magento/luma',
            'theme_path' => 'Thecoachsmb/mytheme',
            'theme_title' => 'Thecoachsmb Mytheme',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'Thecoachsmb/mytheme',
        ],
        'adminhtml/Thecoachsmb/mytheme' => [
            'parent_id' => 'Magento/backend',
            'theme_path' => 'Thecoachsmb/mytheme',
            'theme_title' => 'Thecoachsmb Admin Mytheme',
            'is_featured' => '0',
            'area' => 'adminhtml',
            'type' => '0',
            'code' => 'Thecoachsmb/mytheme',
